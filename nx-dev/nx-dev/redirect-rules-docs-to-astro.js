...
const docsToAstroRedirects = {
  ...
  '/ci/reference/launch-templates': '/docs/reference/launch-templates',
  ...
  '/nx-enterprise/powerpack': '/docs/enterprise/powerpack-features',
  ...
  '/recipes/tips-n-tricks': '/docs/guides/tips-and-tricks',
  ...
  '/recipes/tips-n-tricks/standalone-to-monorepo':
    '/docs/guides/tips-and-tricks/standalone-to-monorepo',
  ...
  '/recipes/tips-n-tricks/browser-support':
    '/docs/guides/tips-and-tricks/browser-support',
  '/recipes/tips-n-tricks/include-assets-in-build':
    '/docs/guides/tips-and-tricks/include-assets-in-build',
  '/recipes/tips-n-tricks/include-all-packagejson':
    '/docs/guides/tips-and-tricks/include-all-packagejson',
  '/recipes/tips-n-tricks/identify-dependencies-between-folders':
    '/docs/guides/tips-and-tricks/identify-dependencies-between-folders',
  '/recipes/tips-n-tricks/analyze-source-files':
    '/docs/guides/tips-and-tricks/analyze-source-files',
  '/recipes/tips-n-tricks/advanced-update':
    '/docs/guides/tips-and-tricks/advanced-update',
  ...
  '/docs/reference/devkit': '/docs/reference/benchmarks/caching', // TODO: missing
  ...
  '/reference/core-api/devkit/documents/ngcli_adapter/NxScopedHost':
    '/docs/reference/devkit/NxScopedHost',
  ...
  '/reference/core-api/devkit/documents/ngcli_adapter/mockSchematicsForTesting':
    '/docs/reference/devkit/mockSchematicsForTesting',
  '/reference/core-api/devkit/documents/ngcli_adapter/wrapAngularDevkitSchematic':
    '/docs/reference/devkit/wrapAngularDevkitSchematic',
  ...
  '/technologies/node/express/api/executors':
    '/docs/technologies/node/express/executors',
  ...
  '/technologies/node/express/api/migrations':
    '/docs/technologies/node/express/migrations',
  ...
  '/technologies/node/nest/api/executors':
    '/docs/technologies/node/nest/executors',
  ...
  '/technologies/vue/nuxt/api/executors':
    '/docs/technologies/vue/nuxt/executors',
  ...
  '/technologies/build-tools/rsbuild/api/executors':
    '/docs/technologies/build-tools/rsbuild/executors',
  ...
  '/technologies/build-tools/rsbuild/api/migrations':
    '/docs/technologies/build-tools/rsbuild/migrations',
  ...
  '/technologies/java/api/executors': '/docs/getting-started/tutorials/gradle',
  '/technologies/java/api/generators': '/docs/getting-started/tutorials/gradle',
  '/technologies/java/api/generators/init':
    '/docs/technologies/java/generators',
  '/technologies/java/api/generators/ci-workflow':
    '/docs/technologies/java/generators',
  '/technologies/java/api/migrations': '/docs/getting-started/tutorials/gradle',
  ...
  '/technologies/module-federation/api/executors':
    '/docs/technologies/module-federation/executors',
  '/technologies/module-federation/api/generators':
    '/docs/technologies/module-federation/generators',
  ...
  '/showcase/example-repos/add-solid': '/docs/getting-started/into',
  '/showcase/example-repos/add-qwik': '/docs/getting-started/into',
  '/showcase/example-repos/add-rust': '/docs/getting-started/into',
  '/showcase/example-repos/add-dotnet': '/docs/getting-started/into',
  '/showcase/example-repos/add-astro': '/docs/getting-started/into',
  '/showcase/example-repos/add-svelte': '/docs/getting-started/into',
  '/showcase/example-repos/add-fastify': '/docs/getting-started/into',
  '/showcase/example-repos/apollo-react': '/docs/getting-started/into',
  '/showcase/example-repos/nestjs-prisma': '/docs/getting-started/into',
  '/showcase/example-repos/mongo-fastify': '/docs/getting-started/into',
  '/showcase/example-repos/redis-fastify': '/docs/getting-started/into',
  '/showcase/example-repos/postgres-fastify': '/docs/getting-started/into',
  '/showcase/example-repos/serverless-fastify-planetscale':
    '/docs/getting-started/into',
  '/showcase/example-repos/mfe': '/docs/getting-started/into',
